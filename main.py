...
CURRENT_ANNOUNCEMENT_ID = "quiet_hours_silent_2026_02"
...
async def broadcast_announcements():
    ...
    for user in users:
        ...
        # Надсилаємо всім користувачам, хто ще не бачив це сповіщення
        if last_ann_id != CURRENT_ANNOUNCEMENT_ID:
            text = (
                "🆕 **Оновлення: Гнучкий «Тихий режим»!**\n\n"
                "Тепер ви можете самі обирати, як бот поводитиметься під час ваших тихих годин:\n\n"
                "• **🔕 Без звуку** — сповіщення про оновлення та нагадування прийдуть, але телефон не турбуватиме вас звуковим сигналом.\n\n"
                "• **🚫 Не надсилати** — повна тиша, бот нічого не писатиме до завершення тихих годин.\n\n"
                "⚙️ **Як налаштувати?**\n"
                "Перейдіть у: **Змінити налаштування** -> **🔔 Сповіщення** -> **Режим**.\n\n"
                "⚠️ **Увага!** Функціонал працює у тестовому режимі, тому можливі помилки. Дякуємо за допомогу у тестуванні та за те, що ви з нами! ⚡️"
            )
            try:
